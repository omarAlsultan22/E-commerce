...
class FrenchCubit extends Cubit<CubitStates> {
  FrenchCubit() : super(InitialState());

  static FrenchCubit get(context) => BlocProvider.of(context);
  ...
  Future<void> getDataSearch(String searchText) async {
    final _filteredData = await fetchPartialMatch(query: searchText, collectionId: 'french');
